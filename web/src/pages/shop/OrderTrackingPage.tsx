...
export default function OrderTrackingPage() {
  ...
  useEffect(() => {
    ...
    api.orders
      .getStatus(orderNumber.trim().slice(0, 50))
      .then((res) => {
        if (isMounted) {
          setOrder(res.order);
          setLoading(false);
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  return (
                    <div key={index} className="flex justify-between items-center bg-stone-50 p-4 rounded-xl">
                      ...
                      <div className="text-right">
                        <div className="font-black text-[15px] text-black">
        ...
        <div className="mt-8 flex flex-col gap-4">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-5 bg-[#25D366] text-white rounded-xl font-black text-lg hover:bg-[#1ebd5a] transition-all shadow-lg shadow-[#25D366]/30"
          >
