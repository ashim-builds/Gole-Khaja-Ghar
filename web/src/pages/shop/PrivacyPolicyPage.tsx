      ...
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-7 md:p-10 space-y-10">
            ...
            <div className="text-stone-600 font-medium leading-relaxed space-y-3">
              ...
              <ul className="space-y-2 pl-4">
                {[
                  ...
                  "Shopping Cart details: Selected items, weights, and quantities are saved securely in our database linked directly to your authenticated user account",
            ...
            <div className="text-stone-600 font-medium leading-relaxed space-y-2">
              ...
              <ul className="space-y-2 pl-4">
                {[
                  ...
                  "Contact you for delivery coordination via phone or WhatsApp",
          ...
          <section>
            ...
            <div className="text-stone-600 font-medium leading-relaxed space-y-3">
              <p>
                Your data is stored securely in our database with encrypted connections. We implement industry-standard security practices including:
              </p>
              <ul className="space-y-2 pl-4">
                {[
                  "Password hashing using bcrypt — your plain password is never stored",
          ...
          <section>
            ...
            <div className="text-stone-600 font-medium leading-relaxed space-y-2">
              ...
              <p className="mt-3">
                We do <strong>not</strong> sell, trade, or share your personal information with any other third parties.
              </p>
            </div>
          </section>
          ...
          <section className="bg-stone-50 rounded-2xl p-6">
            ...
            <div className="space-y-2 text-stone-600 font-medium text-sm">
              <p className="flex items-center gap-2">
                ...
                <a href="tel:+9779804146136" className="hover:text-primary transition-colors">
                  +977 9804146136
                </a>
                <span>/</span>
