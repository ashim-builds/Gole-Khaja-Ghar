    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center px-4 py-20">
      <div className="text-center max-w-lg mx-auto">
        ...
        <p className="text-stone-500 font-medium text-base md:text-lg mb-2">
          Looks like this page went missing — just like the last snack in the bag.
        </p>
          ...
          <div className="flex flex-col items-center gap-2">
            {[
              ...
              <Link
                key={link.href}
                to={link.href}
                className="flex items-center gap-1.5 text-sm font-bold text-stone-500 hover:text-primary transition-colors cursor-pointer"
              >
