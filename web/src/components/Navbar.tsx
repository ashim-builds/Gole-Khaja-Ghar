            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4 border-l border-[#222222] pl-6">
                ...
                >
                  ...
                  {totalItems > 0 && (
                    <span className="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-black bg-primary rounded-full">
                      {totalItems}
                    </span>
                  )}
                </button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`md:hidden overflow-hidden ${scrolled ? "bg-black/70 backdrop-blur-lg w-[calc(100%-2rem)] rounded-3xl mt-2 border border-white/10 shadow-2xl max-w-4xl" : "bg-[#111111] w-full border-b border-[#222222]"}`}
          >
