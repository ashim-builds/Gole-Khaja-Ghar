...
// Name regex: Only English letters and spaces, 2 to 60 chars
export const nameRegex = /^[a-zA-Z\s]{2,60}$/;

// Phone regex: Exactly 10 digits starting with 9 (Nepali standard)
...
// Order Item Schema for Checkout
...
// Helper for escaping regex strings to prevent ReDoS
